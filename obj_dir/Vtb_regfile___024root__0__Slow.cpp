...
#endif
            VL_FATAL_MT("tb/tb_regfile.v", 3, "", "Settle region did not converge after 100 tries");
        }
...
VL_ATTR_COLD void Vtb_regfile___024root___ctor_var_reset(Vtb_regfile___024root* vlSelf) {
    ...
    vlSelf->tb_regfile__DOT__wd = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 12429365669151159866ull);
    vlSelf->tb_regfile__DOT__rd1 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 3710763413753391827ull);
